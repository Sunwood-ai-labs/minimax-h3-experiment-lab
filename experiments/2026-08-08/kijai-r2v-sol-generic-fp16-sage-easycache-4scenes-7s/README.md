...
- Experiment ID: '2026-08-08-kijai-r2v-sol-generic-fp16-sage-easycache-4scenes-7s'
- Status: verified
...
The baseline values are from [the previous verified 4-scene experiment](../kijai-r2v-multi-reference-4scenes-7s/README.md). The optimized values are from the saved reports.
...
|---:|---|---|---|---:|
| 1 | Background/location | [background reference sheet](./references/MiniMax_H3_R2V_background_reference_sheet.png) | 5DA392A5655261637B1932CA5A6D6762A2ECF5682A01F1409063831981221038 | 1672×941, 2,545,156 bytes |
| 2 | Mina | [Mina reference sheet](./references/MiniMax_H3_R2V_mina_reference_sheet.png) | 0D46C441160B8E7768F55D65926EB859D3500C21FD6472182FAEEB8AE09D4D6B | 1672×941, 2,180,477 bytes |
| 3 | Ren | [Ren reference sheet](./references/MiniMax_H3_R2V_ren_reference_sheet.png) | 3449B9DEF4C05694ACC7C84EDF6DFD06A08F625CE7D094CBC8B195128A90FF36 | 1672×941, 1,967,565 bytes |
...
$exp = '.\experiments\2026-08-08\kijai-r2v-sol-generic-fp16-sage-easycache-4scenes-7s'
Copy-Item -LiteralPath "$exp\references\*.png" -Destination '.\runtime\4090\input' -Force
