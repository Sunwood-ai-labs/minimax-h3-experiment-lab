...
- ID: `2026-08-08-kijai-scenes-i2v`
- Status: `verified`
- GPU: RTX 4090
...
.\scripts\run-h3-post-condition.ps1 `
  -Gpu 4090 -Port 8188 `
  -Workflow .\experiments\2026-08-08\kijai-scenes\workflows\minimax_h3_kijai_lightx2v_4step_i2v_sa_solver_car_1344x768_api.json `
...
- [Kijai/LightX2V 4-step基礎実験](../kijai-lightx2v-4step/README.md)
- [出典と解釈境界](./sources.md)
