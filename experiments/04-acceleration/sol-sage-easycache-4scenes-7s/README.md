...
The baseline values are from [the previous verified 4-scene experiment](../../03-reference-conditioned/multi-reference-r2v-4scenes-7s/README.md). The optimized values are from the saved reports.
