...
python scripts/build-h3-mv-workflows.py `
  --output-dir experiments/2026-08-09/h3-mv-jpop-5segment/workflows
...
npx hyperframes init `
  experiments/2026-08-09/h3-mv-jpop-5segment/hyperframes-mv-lyrics `
...
python scripts/build-h3-mv-lyric-frames.py `
  --output-dir experiments/2026-08-09/h3-mv-jpop-5segment/hyperframes-mv-lyrics/compositions/frames `
  --audio-data experiments/2026-08-09/h3-mv-jpop-5segment/audio-data.json

node scripts/patch-h3-mv-hyperframes-index.mjs `
  experiments/2026-08-09/h3-mv-jpop-5segment/hyperframes-mv-lyrics

cd experiments/2026-08-09/h3-mv-jpop-5segment/hyperframes-mv-lyrics
npm install
